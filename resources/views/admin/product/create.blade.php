<x-admin-layout>
  ...
  <x-slot name="header">
      <nav class="breadcrumb pd-0 mg-0 tx-12">
          ...
          <span class="breadcrumb-item active">إضافة منتج</span>
      </nav>
  </x-slot>
  <x-slot name="title">
            ...
            <div class="row mg-b-25">
              <div class="col-lg-6">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="name_ar" value="{{ old('name_ar') }}" placeholder="ادخل اسم المنتج بالعربي">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-6">
                <div class="form-group">
                  <label class="form-control-label">الاسم بالانجليزي: <span class="tx-danger">*</span></label>
                  <input class="form-control" type="text" name="name" value="{{ old('name') }}" placeholder="ادخل اسم المنتج بالانجليزي">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-12">
              ...
              <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                <label class="ckbox">
                  <input type="checkbox" name="is_featured" {{ old('is_featured') ? 'checked' : ''}} value="1"><span>المنتج مميز ؟ <small>المنتجات المميزة سيتم عرضها على الصفحة الرئيسية</small></span>
                </label>
              </div><!-- col-8 -->
            </div>
          </div><!-- tab-pane -->
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-12">
                <div class="form-group mg-b-10-force">
                  ...
                  <textarea class="form-control summernote" type="text" name="descr_ar" placeholder="ادخل الوصف بالعربي">{{ old('descr_ar') }}</textarea>
                </div>
              </div><!-- col-8 -->
              <div class="col-lg-12">
                <div class="form-group mg-b-10-force">
                  <label class="form-control-label">الوصف بالانجليزي: <span class="tx-danger">*</span></label>
                  <textarea class="form-control summernote" type="text" name="descr" placeholder="ادخل الوصف بالانجليزي">{{ old('descr') }}</textarea>
                </div>
              </div><!-- col-8 -->
            </div>
          </div><!-- tab-pane -->
